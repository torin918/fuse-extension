...
export interface ChunkedCanisterWasm {
    ...
    chunk_hashes_list: (Uint8Array | number[])[];
...
export type LogVisibility = { controllers: null } | { public: null } | { allowed_viewers: Principal[] };
...
export interface _SERVICE {
    ...
    manage_dapp_canister_settings: ActorMethod<[ManageDappCanisterSettingsRequest], ManageDappCanisterSettingsResponse>;
