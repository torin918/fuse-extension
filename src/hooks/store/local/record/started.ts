...
import { LOCAL_KEY_RECORD_STARTED } from '../../keys';

// ! always try to use this value to avoid BLINK
type DataType = number;
const get_key = (identity_network: IdentityNetwork): string => LOCAL_KEY_RECORD_STARTED(identity_network);
const get_default_value = (): DataType => 0; // 0 means empty
...
// record started -> // * local
export const useRecordStartedInner = (
    storage: Storage,
