...
export const TOKEN_INFO_ETHEREUM_ETHEREUM: EthereumTokenInfo = { address: '0xEeeeeEeeeEeEeeEeEeEeeEEEeeeeEeeeeeeeEEeE', name: 'Ethereum',      symbol: 'ETH',   decimals: 18, standards: [EthereumTokenStandard.NATIVE] };
...
export const PRESET_ALL_TOKEN_INFO_ETHEREUM: TokenInfo[] = [
    { info: { ethereum: TOKEN_INFO_ETHEREUM_ETHEREUM }, tags: [TokenTag.ChainEthereum] },
